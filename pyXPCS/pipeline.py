...
# def locate_direct_beam(detector_position, two_theta, gamma):
#     return x, y
...
class MTAutocorr(object):
    ...
    def __init__(self, detector_distance, pixel_size, dead_pixels, flat_field, beamline_energy, wavelength, direct_beam_location, **kwargs):
    # ^ some of this is for creating the mask/labels

    def __call__(images, dark_images, dict_of_indices, num_buffers, num_levels):
...
def refine_images(images, flat_field, beamstop_mask):
    for image in images:
        yield image - flat_field
